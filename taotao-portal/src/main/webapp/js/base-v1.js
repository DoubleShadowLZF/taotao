 ...
 */
function login() {
    return location.href = "http://localhost:4004/page/login";
}
function regist() {
    return location.href = "http://localhost:4004/page/register";
}
...
function search(a) {
    // var b = "http://localhost:4002/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
    var b = "http://localhost:4002/search.html?q=" + document.getElementById(a).value;
